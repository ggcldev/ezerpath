...
- [ ] Create service modules:
  ...
  - [ ] `services/ai_chat_service.rs` (`IN PROGRESS`: turn setup, blocked replies, ranking/keyword/describe handling, routing, formatting, JSON response shapes, and semantic fallback extracted)
